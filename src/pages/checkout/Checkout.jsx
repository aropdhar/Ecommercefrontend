...
import { useGetUserWiseCartQuery, usePlaceOrderMutation } from '../../Features/Api/exclusiveApi'
     ...
     onSubmit: async (values) => {
       try {
            ...
            const orderinfo = {
                ...
                paymentinfo: {
                    paymentmathod: values.paymentMethod.toLowerCase()
                }
            }
            ...
            <div className='flex mt-[48px] items-start justify-between'>
                <form onSubmit={formik.handleSubmit}>
                    <div className='flex flex-wrap gap-3'>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="firstname" name="firstname" onChange={formik.handleChange} value={formik.values.firstname} placeholder='firstname' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="lastname" name="lastname" onChange={formik.handleChange} value={formik.values.lastname} placeholder='lastname' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="email" id="email" name="email" onChange={formik.handleChange} value={formik.values.email} placeholder='email' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="number" id="number" name="number" onChange={formik.handleChange} value={formik.values.number} placeholder='number' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="address1" name="address1" onChange={formik.handleChange} value={formik.values.address1} placeholder='address1' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="address2" name="address2" onChange={formik.handleChange} value={formik.values.address2} placeholder='address2' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            <label className='text-[16px] font-poppins font-normal leading-[24px] text-button_DB4444 opacity-[0.5]' htmlFor="email">City</label>
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="city" name="city" onChange={formik.handleChange} value={formik.values.city} placeholder='city' onFocus={handlefocus} />
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="text" id="district" name="district" onChange={formik.handleChange} value={formik.values.district} placeholder='district' onFocus={handlefocus}/>
                        </div>
                        <div className='flex flex-col gap-y-[8px]'>
                            ...
                            <input className='w-[345px] bg-[#F5F5F5] rounded py-[10px] pl-[10px]' type="number" id="postcode" name="postcode" onChange={formik.handleChange} value={formik.values.postcode} placeholder='postcode' onFocus={handlefocus}/>
                        </div>
                    ...
                    {loading ? (<button type="submit" className='py-[16px] px-[48px] text-[16px] font-poppins inline-block text-start font-medium rounded  text-white bg-button_DB4444 '>Loading...</button>) : (<button type="submit" className='py-[16px] px-[48px] text-[16px] font-poppins inline-block text-start font-medium rounded  text-white bg-button_DB4444 '>Confirm Order</button>)
                    }     
                ...
                <div>
                    ...
                    <div className=' py-[32px] rounded'>
                        ...
                        <div className='flex mt-[32px] items-center gap-x-[16px]'>
